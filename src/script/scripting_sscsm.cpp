...
SSCSMScripting::SSCSMScripting(Client *client):
...
void SSCSMScripting::on_client_ready(LocalPlayer *localplayer)
{
	lua_State *L = getStack();
	LuaLocalPlayer::create(L, localplayer);
}

void SSCSMScripting::on_camera_ready(Camera *camera)
{
