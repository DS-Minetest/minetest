...
const ToClientCommandHandler toClientCommandTable[TOCLIENT_NUM_MSG_TYPES] =
{
	...
	{ "TOCLIENT_SSCSM_BLA",                TOCLIENT_STATE_CONNECTED, &Client::handleCommand_SSCSMBla }, // 0x2B
	{ "TOCLIENT_SSCSM_TESTFILE",           TOCLIENT_STATE_CONNECTED, &Client::handleCommand_SSCSMTestfile }, // 0x2C
